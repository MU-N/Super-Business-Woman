...
namespace MoreMountains.Feedbacks
{
    ...
    public abstract class MMFeedback : MonoBehaviour
    {
        ...
        public virtual void SetSequence(MMSequence newSequence)
        {
            ...
            if (Timing.Sequence != null)
            {
                _sequenceDelayWaitForSeconds = new WaitForSeconds(ApplyTimeMultiplier(Timing.DelayBetweenRepeats) + Timing.Sequence.Length);
        ...
        public virtual void SetDelayBetweenRepeats(float delay)
        {
            ...
            {
                _betweenDelayWaitForSeconds = new WaitForSeconds(ApplyTimeMultiplier(Timing.DelayBetweenRepeats + FeedbackDuration));
            }
        }
        ...
        public virtual void SetInitialDelay(float delay)
        {
            ...
            if (Timing.InitialDelay > 0f)
            {
                _initialDelayWaitForSeconds = new WaitForSeconds(ApplyTimeMultiplier(Timing.InitialDelay));
            }
        }
